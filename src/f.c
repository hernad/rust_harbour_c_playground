...
HB_FUNC( DBF_TEST )
{
   ...
   do {
	...
	if( hb_xvmPushAliasedFieldExt( symbols + 5, symbols + 6 ) ) break;
	if( hb_xvmPlus() ) break;
	hb_xvmPushStringConst( "]", 1 );
	if( hb_xvmPlus() ) break;
	if( hb_xvmDo( 1 ) ) break;
	...
	hb_xvmPushFuncSymbol( symbols + 4 );
	hb_xvmPushStringConst( "[", 1 );
	if( hb_xvmPushAliasedFieldExt( symbols + 5, symbols + 7 ) ) break;
	if( hb_xvmPlus() ) break;
	hb_xvmPushStringConst( "]", 1 );
	if( hb_xvmPlus() ) break;
	if( hb_xvmDo( 1 ) ) break;
	...
	if( hb_xvmPopAliasedFieldExt( symbols + 5, symbols + 6 ) ) break;
	hb_xvmSetLine( 39 );
	hb_xvmPushStringConst( "Harbour power", 13 );
	if( hb_xvmPopAliasedFieldExt( symbols + 5, symbols + 7 ) ) break;
	hb_xvmSetLine( 40 );
	hb_xvmPushFuncSymbol( symbols + 4 );
	hb_xvmPushStringConst( "[", 1 );
	if( hb_xvmPushAliasedFieldExt( symbols + 5, symbols + 6 ) ) break;
	...
	if( hb_xvmPopAliasedFieldExt( symbols + 5, symbols + 9 ) ) break;
	hb_xvmSetLine( 48 );
	hb_xvmPushDouble( * ( double * ) "F\xB6\xF3\xFD\xD4\x08^@", 10, 3 );
	if( hb_xvmPopAliasedFieldExt( symbols + 5, symbols + 10 ) ) break;
	hb_xvmSetLine( 49 );
	hb_xvmPushFuncSymbol( symbols + 4 );
	hb_xvmPushStringConst( "[", 1 );
	hb_xvmPushFuncSymbol( symbols + 11 );
	if( hb_xvmPushAliasedFieldExt( symbols + 5, symbols + 10 ) ) break;
	...
	hb_xvmPushStringConst( "[", 1 );
	hb_xvmPushFuncSymbol( symbols + 11 );
	if( hb_xvmPushAliasedFieldExt( symbols + 5, symbols + 9 ) ) break;
	if( hb_xvmFunction( 1 ) ) break;
	if( hb_xvmPlus() ) break;
	hb_xvmPushStringConst( "]", 1 );
	if( hb_xvmPlus() ) break;
...
lab00010: ;
	...
	hb_xvmPushFuncSymbol( symbols + 25 );
	{
		static const HB_BYTE codeblock[ 19 ] = {
			108, 5, 87, 9, 92, 2, 15, 21, 28, 10, 73, 108, 5, 87, 9, 92, 
			8, 35, 6 };
